...
public class AddEditActivity extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    if (id == null || id.equals("")) {
      ...
      if (isEdit == 0) {
        ...
        et_nama.setBackgroundTintList(
          ColorStateList.valueOf(getResources().getColor(R.color.white))
        );
        et_nip.setBackgroundTintList(
          ColorStateList.valueOf(getResources().getColor(R.color.white))
        );
        et_nik.setBackgroundTintList(
          ColorStateList.valueOf(getResources().getColor(R.color.white))
        );
        et_divisi.setBackgroundTintList(
          ColorStateList.valueOf(getResources().getColor(R.color.white))
        );
        et_jabatan.setBackgroundTintList(
          ColorStateList.valueOf(getResources().getColor(R.color.white))
        );
        et_telp.setBackgroundTintList(
          ColorStateList.valueOf(getResources().getColor(R.color.white))
        );
        et_usia.setBackgroundTintList(
          ColorStateList.valueOf(getResources().getColor(R.color.white))
        );
        et_alamat.setBackgroundTintList(
          ColorStateList.valueOf(getResources().getColor(R.color.white))
        );
  ...
  void bacaDataKaryawan() {
    HashMap<String, String> data = SQLkaryawan.getDataById(
      Integer.parseInt(AddEditActivity.id)
    );
  ...
  private void addKaryawan() {
    if (
      ...
      String.valueOf(et_nip.getText()).equals(null) ||
      String.valueOf(et_nip.getText()).equals("") ||
      String.valueOf(et_nik.getText()).equals(null) ||
      String.valueOf(et_nik.getText()).equals("") ||
      String.valueOf(et_divisi.getText()).equals(null) ||
      String.valueOf(et_divisi.getText()).equals("") ||
      String.valueOf(et_jabatan.getText()).equals(null) ||
      String.valueOf(et_jabatan.getText()).equals("") ||
      String.valueOf(et_telp.getText()).equals(null) ||
      String.valueOf(et_telp.getText()).equals("") ||
      String.valueOf(et_usia.getText()).equals(null) ||
      String.valueOf(et_usia.getText()).equals("") ||
      String.valueOf(et_alamat.getText()).equals(null) ||
      String.valueOf(et_alamat.getText()).equals("")
    ) {
      Snackbar
        .make(addEditLayout, "Please fill it correctly!", Snackbar.LENGTH_SHORT)
        .show();
      hideKeyboard();
    } else {
      SQLkaryawan.insert(
