...
public class SettingActivity extends AppCompatActivity {
    ...
    void bacaDataUser(String fileName) {
        ...
        if (file.exists()) {
            ...
            HashMap<String, String> dataUser = SQLakun.getDataById(Integer.parseInt(data));
            ...
            finish();
            Snackbar.make(layoutSetting, "error data user tidak tersimpan", Snackbar.LENGTH_SHORT).show();
        }
    }
    ...
    private void edit() {
        if (String.valueOf(et_nama.getText()).equals(null) || String.valueOf(et_nama.getText()).equals("") ||
            ...
            Snackbar.make(layoutSetting, "Please fill it correctly!", Snackbar.LENGTH_SHORT).show();
        } else {
            hideKeyboard();
