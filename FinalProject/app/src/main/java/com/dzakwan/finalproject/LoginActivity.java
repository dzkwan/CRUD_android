...
public class LoginActivity extends AppCompatActivity {
    ...
    private void login() {
        ...
        if (String.valueOf(et_username.getText()).equals(null) || String.valueOf(et_username.getText()).equals("") ||
                String.valueOf(et_password.getText()).equals(null) || String.valueOf(et_password.getText()).equals("")) {
            Snackbar.make(loginLayout, "Please fill it correctly!", Snackbar.LENGTH_SHORT).show();
            hideKeyboard();
            ...
            if (idUser != 0) {
                ...
                et_username.clearFocus();
                et_password.clearFocus();
                Snackbar.make(loginLayout, "username atau password salah!", Snackbar.LENGTH_SHORT).show();
            }
        }
    }
